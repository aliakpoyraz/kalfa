//
//  Klapa-Bridging-Header.h
//
//  Private/undocumented C declarations Klapa relies on.
//
//  Two groups:
...
//
//  Everything else in Klapa uses public CoreGraphics / IOKit API.
//

#ifndef Klapa_Bridging_Header_h
#define Klapa_Bridging_Header_h
