...
final class AppSettings {
    ...
    var language: L10n.Language {
        ...
        set {
            ...
            // The DPI half keeps its own copy in its config file; pushing the
            // change means one picker drives both halves.
            EzDPI.setLanguage(turkish: newValue.prefersTurkish)
        }
    }
